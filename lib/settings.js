    ...
    function setLang(lang) {
        currentLang = lang;
        localStorage.setItem('app_lang', lang); // persist user choice
    ...
    // Expose globally so ES modules (app-core.js) can call it
    window.setLang = setLang;

    // Init — mark nav labels with data-nav-label
    document.addEventListener('DOMContentLoaded', () => {
        // Language is set by initTelegramUser() auto-detect on boot
    });