...
const CONFIG = Object.freeze({
  withdraw: {
    first_min:    1200,   // أول سحبة للمستخدم الجديد
    normal_min:   1200,   // السحب الطبيعي بعد أول سحبة
    normal_level: 1,      // المستوى المطلوب للسحب الطبيعي
    min_active_referrals: 3,  // عدد الإحالات النشطة المطلوبة للسحب
  },
  rewards: {
    referral:          500,   // نقاط لكل إحالة
  ...
  taddy_ads: {
    daily_limit:     100,    // الحد اليومي لإعلانات Taddy
    points_per_ad:   15,    // نقاط لكل إعلان Taddy
    cooldown_ms:     30 * 1000,
...
const CFG = {
  ...
  WITHDRAW_MIN_ACTIVE_REFS: CONFIG.withdraw.min_active_referrals,
  PTS_PER_TON:           100000,
