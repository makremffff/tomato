...
const CONFIG = Object.freeze({
  ...
  rewards: {
    referral:          100,   // تذاكر مسابقة لكل إحالة (بدل 100 نقطة)
...
const CFG = {
  ...
  // ── Competition Ticket Limits ─────────────────────────────
  // [FIX-2,3] حد يومي للتذاكر وحد كل عملية منح
  COMPETITION_MAX_TICKETS_PER_DAY: 500,  // أقصى تذاكر في اليوم لكل مستخدم
  COMPETITION_MAX_GRANT_PER_CALL:  50,   // أقصى تذاكر في عملية منح واحدة (= MTG_TICKET_COUNT)
