...
const RC_STRINGS = {
  ar: {
    ...
    'rewards.taddyTitle': 'مشاهدة Taddy',
    'rewards.taddyDesc': 'احصل على {points} نقاط',
    'rewards.taddyWatch': 'مشاهدة',
    'surf.cardTitle': 'تصفح واربح',
    'surf.cardDesc': 'دقيقة وحدة، دفعات صغيرة كل 5 ثواني',
    'surf.start': 'ابدأ',
    ...
    'surf.consentTitle': '⚠️ تنبيه قبل المتابعة',
    'surf.consentBody': 'يجب أن تعرف أنه من الممكن أن تظهر إعلانات غير لائقة أثناء هذه الجلسة. نحن لا نعرض هذه الإعلانات ولا نتحكم بمحتواها — هي من طرف شبكات إعلانية خارجية.',
    'surf.dontRemind': 'لا تذكرني كل مرة',
  ...
  en: {
    ...
    'rewards.taddyTitle': 'Watch Taddy',
    'rewards.taddyDesc': 'Get {points} points',
    'rewards.taddyWatch': 'Watch',
    'surf.cardTitle': 'Surf & Earn',
    'surf.cardDesc': 'One minute, small payouts every 5 seconds',
    'surf.start': 'Start',
    ...
    'surf.consentTitle': '⚠️ Before you continue',
    'surf.consentBody': 'Please note that inappropriate ads may appear during this session. We do not display these ads or control their content — they come from third-party ad networks.',
    'surf.dontRemind': "Don't remind me every time",
