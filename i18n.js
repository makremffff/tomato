...
const RC_STRINGS = {
  ar: {
    ...
    'rewards.smartlinkTitle': 'رابط سريع',
    'rewards.smartlinkDesc': 'افتح الرابط، استنى 10 ثواني، واستلم نقاطك',
    'rewards.smartlinkStart': 'ابدأ',
    'rewards.smartlinkWaiting': 'استنى {sec} ث',
  ...
  en: {
    ...
    'rewards.smartlinkTitle': 'Quick Link',
    'rewards.smartlinkDesc': 'Open the link, wait 10 seconds, and claim your points',
    'rewards.smartlinkStart': 'Start',
    'rewards.smartlinkWaiting': 'Wait {sec}s',
