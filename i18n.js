...
const RC_STRINGS = {
  ar: {
    ...
    'surf.cardDesc': 'دقيقة وحدة، دفعات صغيرة كل 10 ثواني',
    'surf.start': 'ابدأ',
    'surf.title': 'تصفح واربح',
    'surf.sub': 'خلي الصفحة مفتوحة وشاهد الإعلانات — كل 5 ثواني بتاخذ دفعة صغيرة',
    'surf.adPlaceholder': 'مكان الإعلان',
    'surf.completed': 'خلصت الجلسة! 🎉 تمت إضافة الأرباح لرصيدك',
  ...
  en: {
    ...
    'surf.cardDesc': 'One minute, small payouts every 10 seconds',
    'surf.start': 'Start',
    'surf.title': 'Surf & Earn',
    'surf.sub': 'Keep this page open and watch the ads — every 5 seconds you get a small payout',
    'surf.adPlaceholder': 'Ad space',
    'surf.completed': 'Session complete! 🎉 Earnings added to your balance',
