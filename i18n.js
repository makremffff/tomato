...
const RC_STRINGS = {
  ar: {
    ...
    'tasks.dailyBonusTitle': 'مكافأة يومية',
    'tasks.dailyBonusDesc': 'استلمتها {progress}/{required} — 3 مرات كل 24 ساعة',
    'tasks.dailyBonusStart': 'ابدأ',
  ...
  en: {
    ...
    'tasks.taskAdRewardTag': '+$0.001',
    'tasks.browse10': 'Browse 10 times',
    ...
    'tasks.dailyBonusTitle': 'Daily Bonus',
    'tasks.dailyBonusDesc': 'Claimed {progress}/{required} — 3 times every 24 hours',
    'tasks.dailyBonusStart': 'Start',
