...
const RC_STRINGS = {
  ar: {
    ...
    'rewards.item.balance_001usd': 'رصيد إضافي 0.01$',
    ...
    'surf.cardTitle': 'تصفح واربح',
    'surf.cardDesc': '130 ثانية، دفعات صغيرة كل 10 ثواني',
    'surf.start': 'ابدأ',
    'surf.title': 'تصفح واربح',
    'surf.sub': 'خلي الصفحة مفتوحة وشاهد الإعلانات — كل 10 ثواني بتاخذ دفعة صغيرة',
    'surf.adPlaceholder': 'مكان الإعلان',
    'surf.completed': 'خلصت الجلسة! 🎉 ربحت بالضبط +{amount}$ وتمت إضافتها لرصيدك',
    'surf.dailyLimitReached': 'وصلت للحد الأقصى من جلسات اليوم، جرب بكرة',
    'surf.underDevelopment': 'هذه الميزة قيد التطوير حالياً',
    'surf.sessionError': 'صار خطأ بالجلسة، حاول من جديد',
    'surf.consentTitle': '⚠️ تنبيه هام قبل المتابعة',
    'surf.consentBody': 'قد تظهر خلال هذه الجلسة إعلانات غير لائقة. نحن لا نعرض هذه الإعلانات ولا نتحكم بمحتواها — هي من طرف شبكات إعلانية خارجية بالكامل. بالمتابعة، أنت تقر بأنك مسؤول بشكل كامل عن قرارك بالتصفح، وأنك غير مُجبر على مشاهدة أي محتوى لست مقتنعاً به، ويمكنك الخروج من الصفحة في أي لحظة.',
    'surf.agreeStart': 'أوافق وابدأ',
    'surf.secondsLeft': 'ثانية متبقية',
    'surf.loadingAds': 'جاري تحميل الإعلانات...',
    'rewards.dailyBonusTitle': 'مكافأة يومية',
    'rewards.dailyBonusDesc': 'استلمتها {progress}/{required} — 3 مرات كل 24 ساعة',
    'rewards.dailyBonusStart': 'ابدأ',
    'rewards.dailyBonusWaiting': 'استنى {sec} ث',
    'rewards.dailyBonusClaim': 'استلام',
    'rewards.dailyBonusDone': 'خلصت مرات اليوم',
    'rewards.dailyBonusSuccess': 'حصلت على {amount}$ 🎉',
    'rewards.dailyBonusLimit': 'وصلت للحد الأقصى، جرب بعد 24 ساعة',
    ...
    'toast.channelTaskLocked': 'هاي المهمة مقفولة عندك لأنك غادرت القناة قبل — تواصل مع الدعم لو في استفسار',
    ...
    'errors.channel_required': 'لازم تكون عضو بالقناة عشان تقدر تسحب',
    ...
    'modal.adIncompleteTitle': '⚠️ لم تكتمل مشاهدة الإعلان',
    'modal.adIncompleteSub': 'للحصول على المكافأة، يجب التفاعل مع الإعلان وإكماله حتى النهاية. إذا ظهر زر مثل Play أو Install أو Subscribe أو أي زر آخر داخل الإعلان، اضغط عليه حسب المطلوب ثم ارجع بعد الانتهاء.',
    'modal.adIncompleteSub2': 'بعد إكمال جميع خطوات الإعلان، ستتم إضافة مكافأتك تلقائيًا.',
    'modal.ok': 'تمام',
    ...
    'tx.surfSession': 'تصفح واربح — جلسة إعلانات',
  },
  ...
  en: {
    ...
    'rewards.item.balance_001usd': 'Extra balance $0.01',
    ...
    'surf.cardTitle': 'Surf & Earn',
    'surf.cardDesc': '130 seconds, small payouts every 10 seconds',
    'surf.start': 'Start',
    'surf.title': 'Surf & Earn',
    'surf.sub': 'Keep this page open and watch the ads — every 10 seconds you get a small payout',
    'surf.adPlaceholder': 'Ad space',
    'surf.completed': 'Session complete! 🎉 You earned exactly +{amount}$ and it was added to your balance',
    'surf.dailyLimitReached': "You've reached today's session limit, try again tomorrow",
    'surf.underDevelopment': 'This feature is currently under development',
    'surf.sessionError': 'Something went wrong with the session, please try again',
    'surf.consentTitle': '⚠️ Important notice before continuing',
    'surf.consentBody': 'Inappropriate ads may appear during this session. We do not display these ads or control their content — they come entirely from third-party ad networks. By continuing, you acknowledge that you are fully responsible for your decision to browse, that you are not forced to view any content you do not agree with, and that you can leave this page at any time.',
    'surf.agreeStart': 'Agree & Start',
    'surf.secondsLeft': 'seconds left',
    'surf.loadingAds': 'Loading ads...',
    'rewards.dailyBonusTitle': 'Daily Bonus',
    'rewards.dailyBonusDesc': 'Claimed {progress}/{required} — 3 times every 24 hours',
    'rewards.dailyBonusStart': 'Start',
    'rewards.dailyBonusWaiting': 'Wait {sec}s',
    'rewards.dailyBonusClaim': 'Claim',
    'rewards.dailyBonusDone': "You've claimed all for today",
    'rewards.dailyBonusSuccess': 'You earned {amount}$ 🎉',
    'rewards.dailyBonusLimit': 'Limit reached, try again in 24 hours',
    ...
    'toast.channelTaskLocked': "This task is locked for your account because you left the channel before — contact support if you have questions",
    ...
    'errors.channel_required': 'You must be a channel member to withdraw',
    ...
    'modal.adIncompleteTitle': '⚠️ Ad Not Completed',
    'modal.adIncompleteSub': 'To get the reward, you need to interact with the ad and complete it fully. If a button like Play, Install, Subscribe, or similar appears inside the ad, tap it as required, then come back once finished.',
    'modal.adIncompleteSub2': 'Once all ad steps are completed, your reward will be added automatically.',
    'modal.ok': 'OK',
    ...
    'tx.surfSession': 'Surf & Earn — ad session',
  },
};
